...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "-" + "2fbd1ac654af96ca3f5c" + ".js";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__GlobalLoader__ = __webpack_require__(2);
...
var NavigationDesktop = function (_Component2) {
    ...
    function NavigationDesktop(props) {
        ...
        _this2.contact = function () {
            _this2.setState({ contact: !_this2.state.contact, scrollHidden: false });
        };
        _this2.navigate = function () {
            _this2.setState({ contact: false });
        };
        _this2.state = {
            contact: false,
            scrollHidden: false,
    ...
    NavigationDesktop.prototype.render = function render() {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'div', 'navigation-desktop' + (this.props.loading ? '' : ' loaded') + (contact ? ' contact' : '') + (scrollTop && !contact ? ' top' : '') + (scrollHidden ? ' scroll-hidden' : ''), [Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'div', 'navigation-desktop-contact', Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'div', 'navigation-desktop-contact-inner', [Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'h2', null, 'Get in Touch'), Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'p', null, 'Opportunity, cordiality, or just plain curiosity? Either way, feel free to get in touch with one of the ways below!'), Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(16, __WEBPACK_IMPORTED_MODULE_5__Contact__["a" /* default */])])), Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'div', 'navigation-desktop-inner', [Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'div', 'navigation-desktop-left', [Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(16, __WEBPACK_IMPORTED_MODULE_1_inferno_router__["Link"], null, null, {
            'to': '/about/',
            ...
            'style': 'transition-delay:0.14s',
            children: 'BLOG'
        }), Object(__WEBPACK_IMPORTED_MODULE_9_inferno__["createVNode"])(2, 'a', contact ? 'active' : '', 'CONTACT', {
