...
/***/ function(module, exports, __webpack_require__) {
	...
	var _navigationService = __webpack_require__(15);
	...
	_serviceManager2.default.use(_navigationService2.default);
	...
	(0, _umbrellajs.u)('iframe').wrap('<div class="video-wrapper">'); //pretty videos
	...
	exports.default = {
	    init: function init() {
	        ...
	        function doLoad() {
	            ...
	            (0, _umbrellajs.u)('#loader-old-message').remove();
	            var nextMessage = (0, _umbrellajs.u)('<div />').text(messages[rand]).attr({ class: 'loader-message', id: 'loader-next-message' });
	            (0, _umbrellajs.u)('#loader').append(nextMessage);
	            (0, _umbrellajs.u)('#loader-main-message').attr({ id: 'loader-old-message' });
	        ...
	        onloadServiceInstance.addListener(function () {
	            TweenMax.fromTo('#loader', 0.7, { opacity: 1 }, { opacity: 0, onComplete: function onComplete() {
	                    (0, _umbrellajs.u)('#loader').remove();
	                } });
	        });
	        ...
	        function showItem(index) {
	            ...
	            (0, _umbrellajs.u)('#projects-card-navigation a.active').removeClass('active');
	            projectLinks[index].addClass('active');
	            (0, _umbrellajs.u)('#projects-card').first().style.background = 'linear-gradient(' + projectColors[index] + ', ' + projectColors[index + 1] + ')';
	            var currentlyActive = null;
	            if (currentIndex != -1) {
	                currentlyActive = projectCards[currentIndex];
	                TweenMax.fromTo(currentlyActive.first(), 0.35, { opacity: 1, scale: 1 }, { opacity: 0, scale: 0.75, ease: Power2.easeInOut, onComplete: function onComplete() {
	        ...
	        (0, _umbrellajs.u)('#projects-card-chevron-left').on('click', function () {
	            showItem(currentIndex - 1);
	        });
	        (0, _umbrellajs.u)('#projects-card-chevron-right').on('click', function () {
	            showItem(currentIndex + 1);
	        });
	        for (var i = 0; i < projects.length; i++) {
	            var project = projects[i];
	            var link = (0, _umbrellajs.u)('<a href="javascript:void(0);"></a>');
	            var card = (0, _umbrellajs.u)('<div class="projects-card-item"><div id="projects-card-image" style="background-image:url(\'/assets/lib/img/sites/' + project.image + '\')"></div><img src="/assets/lib/img/whiteoverlay.png" id="projects-card-overlay"/><div id="projects-card-content"><h1 class="card-title">' + project.name + '</h1><h2 class="card-caption">' + project.subtitle + '</h2><a href="' + project.url + '" class="button">SEE PROJECT</a></div></div>');
	            (0, _umbrellajs.u)('#projects-card-navigation').append(link);
	            (0, _umbrellajs.u)('#projects-card').prepend(card);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var navigationService = function () {
	    ...
	    _createClass(navigationService, [{
	        key: 'init',
	        value: function init() {
	            var isHome = (0, _umbrellajs.u)('body').hasClass('home-template');
	            ...
	            var pageScene = new _scrollmagic2.default.Scene({ duration: isHome ? window.innerHeight + "px" : '50px', offset: 0, triggerHook: 0, triggerElement: (0, _umbrellajs.u)('body').first(), reverse: true });
