...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Title__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__img_thinking_jpg__ = __webpack_require__(78);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__views_Blog__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__views_Projects__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Home_scss__ = __webpack_require__(79);
    ...
    function Home(props) {
        ...
        _this6.dragStart = function (e) {
            ...
            if (_this6.state.mouseMode) {
                ...
                if (_this6.lastScrollY < _this6.winHeight * 0.85) {
                    _this6.top = _this6.winHeight * 0.85 - _this6.lastScrollY;
                    window.scrollTo(0, 0);
                    _this6.opened = false;
                } else {
                    _this6.top = _this6.winHeight * 0.85;
                    _this6.content.style.transform = 'translate3d(0, 0, 0)';
                    window.scrollTo(_this6.lastScrollY - _this6.top, 0);
                    _this6.opened = true;
                }
            } else {
                _this6.updatePosition();
            }
            _this6.startTop = _this6.lastScrollY <= 0;
            if (_this6.opened && _this6.lastScrollY < 1) {
                window.scrollTo(0, 1);
            }
        ...
        _this6.dragMove = function (e) {
            ...
            if (_this6.opened && _this6.lastScrollY - y < 1 && _this6.startTop) {
                _this6.opened = false;
        ...
        _this6.onWheel = function (e) {
            if (!_this6.state.mouseMode) {
                ...
                _this6.content.style.transform = 'translate3d(0, ' + _this6.top + 'px, 0)';
                window.scrollTo(0, _this6.lastScrollY + _this6.top);
            }
        };
