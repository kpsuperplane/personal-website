webpackJsonp([0,1],Array(46).concat([
/* 46 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ellipsize__ = __webpack_require__(11);
...
var HorizontalScroll = function (_Component3) {
    ...
    HorizontalScroll.prototype.render = function render() {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(2, 'div', 'h-scroll' + (this.props.className ? ' ' + this.props.className : ''), [Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(2, 'div', 'h-scroll-contents', this.props.children, null, null, this.attachContainer), this.state.selected !== 0 ? Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(2, 'div', 'h-scroll-nav left', Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16, __WEBPACK_IMPORTED_MODULE_10__components_Icon__["b" /* default */], null, null, {
            'icon': __WEBPACK_IMPORTED_MODULE_10__components_Icon__["a" /* Icons */].CHEVRON_LEFT
        }), {
            'onClick': this.prev
        }) : null, this.props.children && this.state.selected !== this.props.children.length - 1 ? Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(2, 'div', 'h-scroll-nav right', Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(16, __WEBPACK_IMPORTED_MODULE_10__components_Icon__["b" /* default */], null, null, {
            'icon': __WEBPACK_IMPORTED_MODULE_10__components_Icon__["a" /* Icons */].CHEVRON_RIGHT
        }), {
            'onClick': this.next
        }) : null, this.props.children ? Object(__WEBPACK_IMPORTED_MODULE_16_inferno__["createVNode"])(2, 'div', 'h-scroll-indicator', [Array.from(new Array(this.props.children.length), function (val, index) {
